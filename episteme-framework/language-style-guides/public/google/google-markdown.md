# Scraped: google-markdown
**Source:** https://google.github.io/styleguide/docguide/style.html
**Fetched:** 2026-03-03T17:38:59.193432+00:00
...
encourages engineers to take ownership of their docs and
...
Fast iteration is your friend. To get long-term improvement,

authors must stay

productive

when making short-term improvements. Set lower standards for each
...
to avoid comments of the form “You should
...
is a dead-simple platform for internal engineering documentation.
...
. If you’d like to claim ownership of the document or
...
after the short introduction. See
...
directive after the introduction
...
the TOC where it should not be.
...
to the right of the page. However,
...
: All our tooling is designed around code, so the
...
. The more engineers use their well-worn coding habits when
...
https://gerrit.googlesource.com/gitiles/+/HEAD/Documentation/markdown.md
...
best practices for creating short, readable tables
...
that two spaces at the end of a line should insert a
...
Best practice is to avoid the need for a
...
An example Markdown shortlink would be:

`Markdown/foo/Markdown/bar.md`
...
See the Markdown guide for more info:
...
/styleguide/docguide/style.html
...
for more info, or check out the
...
, which has suggestions for making docs more
...
says not to use reference links unless you have
...
http://google.com/excessively/long/path/example_site_1

)

| This is example site 1.
...
Use images when it’s easier to

show

a reader something than to

describe

it

. For example, explaining how to navigate a UI is often easier with an
...
http://cs/SomeReallyReallyReallyReallyReallyReallyReallyReallyLongQuery

)

, Firm, Sweet               | Apples keep doctors away.

Banana | Very popular | Trees    | 16 degrees average |
...
, Soft, Sweet | Contrary to popular belief, most apes prefer mangoes. Don't you? See the
...
: Several columns don’t differ across rows, and some
...
: There are a small number of rows relative to
...
in some cells. Tables should tell a succinct story at a

glance.

Lists

and subheadings sometimes suffice to present the same
...
X-34 landspeeder | Whiny farmboys |
...
are used to keep the table cells
...
, Markdown meets almost all needs
