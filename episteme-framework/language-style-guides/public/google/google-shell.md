# Scraped: google-shell
**Source:** https://google.github.io/styleguide/shellguide.html
**Fetched:** 2026-03-03T17:38:58.048560+00:00
...
and minimal flags. Use

set

to set

shell options so that calling your script as
...
. Bear in mind that scripts grow. Rewrite your
...
and a build rule named

foo

.

If the executable will be added directly to the user’s
...
The only exception for using tabs is for the body of
...
"/i/am/an/exceptionally/loooooooooooooooooooooooooooooooooooooooooooooooooooong_file"

long_string_with_long_file

=

"i am including an exceptionally
...
"i am an including an exceptionally
...
bad_long_string_with_long_file

=

"i am including an exceptionally /very/long/file in this long string."
...
principles as with braces when declaring functions. That is:
...
# Confusing use: this is expanded as "
...
# prints 7530 as expected

Aliases

Although commonly seen in
