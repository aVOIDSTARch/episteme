# Scraped: effective-dart
**Source:** https://dart.dev/guides/language/effective-dart
**Fetched:** 2026-03-03T17:39:00.843066+00:00
...
When it comes to things like formatting, and casing,
...
is objectively helpful.

If two pieces of code look different it should be because they
...
Dart was designed to be familiar, so it inherits many of the
...
If there are multiple ways to say something, you should generally pick the
                        ...
                        most concise one. This is not to say you should
...
– This defines the rules for laying out and
...
– This teaches you how to make the best use of
...
– This is the softest guide, but the one
...
guidelines describe practices that should always be followed. There

                        will almost never be a valid reason to stray from them.

DON'T

guidelines are the converse: things that are almost never a good
...
guidelines are practices that you

should

follow. However, there
...
guidelines are the dual to "prefer": stuff you shouldn't do but

                        where there may be good reasons to on rare occasions.

CONSIDER

guidelines are practices that you might or might not want to

                        follow, depending on circumstances, precedents, and your own preference.

Some guidelines describe an
...
is a top-level field, getter, setter, or function.
...
is a constructor, field, getter, setter, function, or
...
is either a library member or a class member.

A

variable

, when used generally, refers to top-level variables,
...
is any named type declaration: a class, typedef, or enum.

A

property

is a top-level variable, getter (inside a class or at the top
...
DON'T import libraries that are inside the

src

directory of another package.

DON'T allow an import path to reach into or out of
...
DON'T discard errors from catches without
...
when disambiguating a

FutureOr<T>

whose type argument could be
...
CONSIDER omitting the verb for a named boolean
...
Unless stated otherwise, the documentation on this site reflects Dart 3.11.0. Page last updated on 2025-09-04.
