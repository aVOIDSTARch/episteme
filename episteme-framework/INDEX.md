# Episteme framework — index (sitemap)

**Purpose:** Single “start here to see everything” index. Links to every major section of the framework. For a perusal-oriented map with section descriptions, use [agent-docs/LIBRARY-MAP.md](agent-docs/LIBRARY-MAP.md). To **act** (slash commands, skills), start from [AGENTS.md](../AGENTS.md) at repo root and the [meta-agent](agent-docs/meta-agent.example.md).

---

## Sections (from framework root)
...
- **Bootstrap (repo root):** [../AGENTS.md](../AGENTS.md)
- **Meta-agent:** [agent-docs/meta-agent.example.md](agent-docs/meta-agent.example.md)
- **Library map (perusal):** [agent-docs/LIBRARY-MAP.md](agent-docs/LIBRARY-MAP.md)
